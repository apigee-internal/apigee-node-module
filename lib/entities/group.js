 ...
 */
var Group = function(options, callback) {
            ...
            if(data.entities) {
              ...
              for (var i = 0; i < count; i++) {
                ...
                if(uuid) {
                  ...
                  var entity = new Entity(entityOptions);
 ...
 *  @return {function} callback(err, data)
 */
Group.prototype.remove = function(options, callback) {
  var self = this;
 ...
 */
Group.prototype.feed = function(callback) {
  var self = this;
 ...
 */
Group.prototype.createGroupActivity = function(options, callback){
